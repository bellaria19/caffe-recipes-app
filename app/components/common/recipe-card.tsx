...
export function RecipeCard({
  ...
  return (
    <Link to={recipeUrl} className='block'>
      <Card className='flex h-[240px] w-full flex-col transition-all duration-300 hover:shadow-lg hover:border-primary/30 hover:bg-card/80'>
        <CardHeader className='h-[40px] flex-shrink-0 pb-2'>
          <div className='flex items-start justify-between'>
            ...
            <Badge
              variant={recipe.brewType === 'espresso' ? 'default' : 'secondary'}
              className={`ml-2 flex-shrink-0 ${
                recipe.brewType === 'espresso'
